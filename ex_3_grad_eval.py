...
try: #condicion a evaluar, el valor ingresado por el usuario debe ser un numero
    ...
    print ('Error, please enter a number in the range between 0.1 and 1') # se envia al usuiario la notificacion de las restricciones de programa
    quit() #se sale del programa

if grade >= 1: #condicion mayor o igual a 1
    print ("error") #se imprime error
    quit() #se sale del programa
elif grade >= 0.9:  #condicion mayor o igual a 0.9
...
elif grade < 0: #condicion menor que cero
    print ("error")  #se imprime error
    quit() #se sale del programa
